...
<html lang="fr">
    ...
    <body>
        ...
        <script>
            var villes = {
                "La kanteen, c'est ICI <br> 30 rue de la visitation RENNES": { "lat": 48.1140322, "lon": -1.6783517 },
                "Lundi Midi <br>V&B Longchamps": { "lat": 48.1294774, "lon": -1.6396325 },
                "Mardi Midi <br>V&B ZI sud est Rennes": { "lat": 48.1140322, "lon": -1.6332117 },
                "Jeudi Midi <br>Hôpital PONTCHAILLOU Rennes": { "lat": 48.1140322, "lon": -1.6783517 },
                "Vendredi Midi <br>Soccer Rennais": { "lat": 48.1007179, "lon": -1.7324282 },

            };
            var tableauMarqueurs = [];

            // On initialise la carte
            var carte = L.map('maCarte').setView([48.852969, 2.349903], 14);
