...
<head>
    ...
    <!-- Site Metas -->
    <title>A la thaï - Cuisine Thaïlandeizh</title>
...
<!-- Ceci est l'un de nos plus gros titre de notre page, c'est une partie du site qui s'affiche avec le texte qui bouge. Pour modifier le texte, soit le texte en blanc et pour le texte qui s'escris seul, c'est dans la balise = data-words= -->                         	
                            <h1>On mange à la thaï <span class="typer" id="some-id" data-delay="200" data-delim=":" data-words="En famille👪:Entre amis🎉:solo" data-colors="red"></span><span class="cursor" data-cursorDisplay="_" data-owner="some-id"></span></h1>
                            <br>
                            <h2> C'est une kanten Thaï mais aussi un food truck depuis 2017 ! </h2>
                            <p>C’est un vrai mélange de culture. Ici on parle anglais, français, thaïlandais et même breton 😏</p>
<!-- ici, tu as le lien pour accéder à ton site de prise de commande full et il y aura également les logos des sites de commande, uber eat, just eat, deliveroo --> 
                            <div class="book-btn">
                                <a href="https://webshop.fulleapps.io/pointofsale/ee630214f255eb3add9b4c6f24ee35eaba99ecf3" class="table-btn hvr-underline-from-center">Je passe commande 🤤</a>
                            <!--    	<img src="/" width="235" height="235" alt="Commander sur Deliveroo" border="0">
                                	<img src="/" width="235" height="235" alt="Commander sur Uber Eat" border="0">
                                	<img src="/" width="235" height="235" alt="Commander sur Just Eat" border="0"> -->
                            
                            </div>
                            <a href="#about">
                            	<br>
<!-- Si tu enlève les balises de commentaire donc ce qui est en gris, ça affichera le bouton de scrool sur la page au niveau de Je passe commande. -->                             	
                            <!--    <div class="mouse"></div> -->
                            </a>
                        </div>
                        <!-- end banner-cell -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					...
					<p><center><font color="white"> Suffit de cliquer sur l'image du réseau social que vous voulez suivre pour y accéder.</font></center></p>
                    <div class="blog-box clearfix">
                        <div class="wow fadeIn" data-wow-duration="1s" data-wow-delay="0.1s">
                            <div class="col-md-6 col-sm-6">
                                <div class="blog-block">
                                    <div class="blog-img-box">
                                        <img src="news-images/social/facebook.png" alt="" />
                                        <div class="overlay">
                                            <a href="https://www.facebook.com/ALATHAIRENNES/"><i class="fa fa-link" aria-hidden="true"></i></a>
                                        </div>
                                    </div>
                                    <div class="blog-dit">
                        ...
                        <div class="wow fadeIn" data-wow-duration="1s" data-wow-delay="0.1s">
                            <div class="col-md-6 col-sm-6">
                                <div class="blog-block">
                                    <div class="blog-img-box">
                                        <img src="news-images/social/instagram.png" alt="" />
                                        <div class="overlay">
                                    ...
                                    <!--    <p><span>2 NOVEMBER, 2014</span></p> -->
                                        <h2>Instagram</h2>
                                        <h4>Suivez-nous sur notre Instagram</h4>
                                    </div>
                                </div>
                            </div>
                ...
                <!--        <div class="wow fadeIn" data-wow-duration="1s" data-wow-delay="0.1s">
                    ...
                    <div class="book-btn"><center>
                                <a href="https://webshop.fulleapps.io/pointofsale/ee630214f255eb3add9b4c6f24ee35eaba99ecf3" class="table-btn hvr-underline-from-center">Je passe commande 🤤</a></center>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <p>Avec un point de restauration qui se déplace au plus prêt de vous et un restaurant fixe :<b>aucune raison de ne pas manger A la Thaï<b></p>
                </div>
                    ...
                    <div class="col-md-4 col-sm-4 text-center">
                        <div class="panel panel-pricing">
                            ...
                            <div class="panel-body text-center">
                                <h3><strong>30 rue de la visitation<br><span>RENNES</span></strong></h3>
                            </div>
                            <ul class="list-group text-center">
                                <li class="list-group-item"><i class="fa fa-check"></i><h3> Du mardi au samedi
                                <br>12:00 - 14:00 / 18:30 - 21:30</h3></li>
                            </ul>
                            <div class="panel-footer">
                                <a class="btn btn-lg btn-block hvr-underline-from-center" href="#">Actuellement fermé</a>
                            </div>
                        </div>
                    </div>
                    <!-- /item -->
                    ...
                    <div class="col-md-4 col-sm-4 text-center">
                        <div class="panel panel-pricing">
                            ...
                            <ul class="list-group text-center">
                                ...
                                <li class="list-group-item"><i class="fa fa-check"></i> 
                                														Mardi midi<br>
																						V&B ZI sud est Rennes</li>
                                <li class="list-group-item"><i class="fa fa-check"></i> Mercredi midi<br>
																						Zone Atalante Champeaux<br>
																						Route de Vezin</li>
                                <li class="list-group-item"><i class="fa fa-check"></i> Jeudi midi<br>
																						Hôpital PONTCHAILLOU Rennes</li>
                                <li class="list-group-item"><i class="fa fa-check"></i> Vendredi midi<br>
																						Soccer Rennais</li>
                                <!-- <li class="list-group-item"><i class="fa fa-check"></i>Si tu veux mettre le samedi ou dimanche</li>-->
                            </ul>
                            <div class="panel-footer">
                                <a class="btn btn-lg btn-block hvr-underline-from-center" href="#">A emporter</a>
                            </div>
                        </div>
                    </div>
                    <!-- /item -->
